  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={`font-mono text-[10px] font-semibold uppercase tracking-[.08em] px-[10px] py-[4px] rounded-full whitespace-nowrap shrink-0 ${STATUS_CLASSES.pendiente}`}
        >
          {STATUS_LABELS.pendiente}
        </span>
      </div>
