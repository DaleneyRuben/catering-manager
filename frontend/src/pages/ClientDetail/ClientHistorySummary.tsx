...
export function ClientHistorySummary({ eventCount, planName, clientSince }: Props) {
  return (
    <div className="px-0.5 py-1.5">
      <p className="text-[10.5px] font-mono uppercase tracking-[.16em] text-olive-600 font-semibold mb-[12px]">
        Registro
      </p>
      <h2 className="font-serif text-[30px] font-semibold leading-[1.05] text-ink mb-[12px]">
        Historial de actividad
      </h2>
      <p className="text-[13.5px] leading-[1.55] text-muted mb-[24px]">
